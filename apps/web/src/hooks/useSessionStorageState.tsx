// https://github.com/imbhargav5/rooks/blob/main/packages/rooks/src/hooks/useSessionStorageState.ts
...
type UseSessionStorateStateReturnValue<S> = [S, Dispatch<S>, () => void];
  ...
  useEffect(() => {
    ...
    if (typeof document !== "undefined") {
      document.addEventListener(
        customEventTypeName,
        listenToCustomEventWithinDocument as EventListenerOrEventListenerObject,
      );
